  ...
  const handleSignUp = (e) => {
    ...
    if (checked) {
      ...
      if (
        ...
        setSuccessMsg(
          `Hello dear ${clientName}, Welcome you to Crest Mark Admin panel. We received your Sign up request. We are processing to validate your access. Till then stay connected and additional assistance will be sent to you by your mail at ${email}`
        );
        setClientName("");
        setEmail("");
        setPhone("");
